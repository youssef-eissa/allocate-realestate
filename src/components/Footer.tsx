...
return (
    <div className="container-fluid  footer ">
        <div className="row ">
            <div className="col-12 p-md-5 p-2 d-flex flex-md-row flex-column justify-content-between ">
                <div  className='col-md-4 col-12 d-flex flex-column align-items-center '>
                    <Link style={{ textDecoration: "none", color: "white" }} className='col-md-10 col-12 d-flex flex-column ' to='/'>
                        <div className='col-12 text-center text-md-start logoContainer'>
                        <img src={logo} alt='logo' className='img-fluid h-100'/>
                    </div>
                    <div className='col-12 d-flex flex-column justify-content-end CompanyName'>
                        <span className='col-12 text-center text-md-start'>Allocate</span>
                        <span className='col-12 text-center text-md-start'>Real Estate Consultancy</span>
                    </div>
                    </Link>
                    <div className='col-md-10 col-12 d-flex justify-content-center justify-content-md-start mt-2'>
                ...
                <div className='col-md-4 my-md-0 my-3 col-12 d-flex flex-column align-items-center '>
                    <Link onClick={()=>window.scrollTo(0,0)} to='/' className='col-12 text-center text-md-start toPage mb-2'>Home</Link>
                    <Link onClick={()=>handlePurpose()} to='/properties' className='col-12 mb-2 toPage text-center text-md-start'>Properties</Link>
                    <Link onClick={()=>window.scrollTo(0,0)} to='/about' className='col-12 toPage mb-2 text-center text-md-start'>About</Link>
                    <Link onClick={()=>window.scrollTo(0,0)} to='/contact' className='col-12 toPage text-center text-md-start'>Contact</Link>
                </div>
                <div className='col-md-4 col-12 d-flex flex-column align-items-center'>
