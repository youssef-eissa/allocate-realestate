    ...
    <div  ref={ref} className='container-fluid mt-4 mt-md-0 p-0'>
        <motion.div animate={animation} className='row BuyAndRent'>
                ...
                <div className='col-12 row-gap-2 gap-md-2 d-flex flex-md-row flex-md-wrap flex-column justify-content-center'>
                    <div className='ImgCon rounded overflow-hidden col-md-5 col-12 justify-content-center position-relative d-flex align-items-center'>
                        ...
                        <div className='ImgCon rounded overflow-hidden col-md-5 col-12 position-relative d-flex align-items-center justify-content-center'>
                    ...
                    <div className='ImgCon rounded overflow-hidden col-md-5 col-12 position-relative d-flex align-items-center justify-content-center'>
                        ...
                        <Link id='sell'  onClick={() => { window.scrollTo(0, 0) }} to={`${isLogged ? '/sell' : '/signin#sell'}`} className='col-3 toPage position-absolute text-center z-3'>Sell</Link>
                    </div>
                </div>
            </WrapperSection>
        </motion.div>
